...
import { stockData } from '@/data/NKE/Data';

import { valuationTable } from '@/data/NKE/ValuationData';

import { priceHistory } from '@/data/NKE/price-history'; // adjust path as needed
    ...
    <main className="p-6 bg-gray-50 dark:bg-neutral-900 min-h-screen">
      ...
      {<div className="w-full mt-12 flex justify-center">
        <div className="w-full max-w-3xl">
          ...
          {/* Price chart */}
          <PriceChart priceData={priceData} companyName="NKE" />
