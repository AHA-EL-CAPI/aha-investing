...
import { stockData } from '@/data/NVDA/Data';

import { valuationTable } from '@/data/NVDA/ValuationData';

import { priceHistory } from '@/data/NVDA/price-history'; // adjust path as needed
  ...
  return (
    <main className="p-6 bg-gray-50 dark:bg-neutral-900 min-h-screen">
      ...
      <h1 className="text-3xl font-bold mb-6 text-black dark:text-white  text-center">
        Principales Métricas de Nvidia
      </h1>
      ...
      {<div className="w-full mt-12 flex justify-center">
        <div className="w-full max-w-3xl">
          ...
          {/* Price chart */}
          <PriceChart priceData={priceData} companyName="NVDA" />
